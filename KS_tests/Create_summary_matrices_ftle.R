...
for (s in 1:6){
  ...
  #First defining the resolution of data we have --only for ftle_with_gaps
  ...
  # #First defining the resolution of data we have --for FTLE without gaps it is 80 for all
  #  npointspertrack <- 80
