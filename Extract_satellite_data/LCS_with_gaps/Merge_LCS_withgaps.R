...
#For synthetic 1
load("Accuracy_lcs_gaps_matched_2_all_1.RData")
...
print("start 10")
#For synthetic 10
load("Accuracy_lcs_gaps_matched_2_all_10.RData")
outT <- subset(outT, select = -c(ftle))
outB <- lapply(outB, function(DF){subset(DF, select = -c(ftle))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(ftle))})
outL <- lapply(outL, function(DF){subset(DF, select = -c(ftle))})
...
#For synthetic 25
print("start 25")
load("Accuracy_lcs_gaps_matched_2_all_25.RData")
outT <- subset(outT, select = -c(ftle))
outB <- lapply(outB, function(DF){subset(DF, select = -c(ftle))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(ftle))})
outL <- lapply(outL, function(DF){subset(DF, select = -c(ftle))})
...
#For synthetic 50
print("start 50")
load("Accuracy_lcs_gaps_matched_2_all_50.RData")
outT <- subset(outT, select = -c(ftle))
outB <- lapply(outB, function(DF){subset(DF, select = -c(ftle))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(ftle))})
outL <- lapply(outL, function(DF){subset(DF, select = -c(ftle))})
...
#For synthetic 111
print("start 111")
load("Accuracy_lcs_gaps_matched_2_all_111.RData")
outT <- subset(outT, select = -c(ftle))
outB <- lapply(outB, function(DF){subset(DF, select = -c(ftle))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(ftle))})
outL <- lapply(outL, function(DF){subset(DF, select = -c(ftle))})
...
save(outT, outB, outL, outC, outJ, file = "Synthetic_all_LCS_gaps.RData")
