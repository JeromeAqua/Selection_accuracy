...
VAR <- "chl"
setwd("/home/jpinti/Importance_accuracy/For_0/Extract_satellite_data")
load("all_tracks0C.RData")

#For synthetic 1
load("Accuracy_matched_chl_1_0C.RData")
print("1")
outT <- subset(outT, select = -c(chl_ocx))
outB <- lapply(outB, function(DF){subset(DF, select = -c(chl_ocx))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(chl_ocx))})
outL <- lapply(outL, function(DF){subset(DF, select = -c(chl_ocx))})
outJ <- lapply(outJ, function(DF){subset(DF, select = -c(chl_ocx))})
...
#For synthetic 10
load("Accuracy_matched_chl_10_0C.RData")
print("10")
outT <- subset(outT, select = -c(chl_ocx))
outB <- lapply(outB, function(DF){subset(DF, select = -c(chl_ocx))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(chl_ocx))})
...
#For synthetic 25
load("Accuracy_matched_chl_25_0C.RData")
print("25")
outT <- subset(outT, select = -c(chl_ocx))
outB <- lapply(outB, function(DF){subset(DF, select = -c(chl_ocx))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(chl_ocx))})
...
#For synthetic 50
load("Accuracy_matched_chl_50_0C.RData")
print("50")
outT <- subset(outT, select = -c(chl_ocx))
outB <- lapply(outB, function(DF){subset(DF, select = -c(chl_ocx))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(chl_ocx))})
...
#For synthetic 111
load("Accuracy_matched_chl_111_0C.RData")
print("111")
outT <- subset(outT, select = -c(chl_ocx))
outB <- lapply(outB, function(DF){subset(DF, select = -c(chl_ocx))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(chl_ocx))})
...
outT$WM_chl_ocx <- outT$chl_ocx #all this because 0 standard deviation
for (i in 1:100){
  outB[[i]]$WM_chl_ocx <- outB[[i]]$chl_ocx
  outL[[i]]$WM_chl_ocx <- outL[[i]]$chl_ocx
  outC[[i]]$WM_chl_ocx <- outC[[i]]$chl_ocx
  outJ[[i]]$WM_chl_ocx <- outJ[[i]]$chl_ocx
  # outH[[i]]$WM_chl_ocx <- outH[[i]]$chl_ocx
}
...
outT$cue <- "chlorophyll"
outB$cue <- "chlorophyll"
outC$cue <- "chlorophyll"
outL$cue <- "chlorophyll"
outJ$cue <- "chlorophyll"
save(outT, outB, outL, outC, outJ, file = "Synthetic_all_chl_0C.RData")
