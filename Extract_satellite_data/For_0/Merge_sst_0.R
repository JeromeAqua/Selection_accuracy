...
#For synthetic 1
load("Accuracy_matched_sst_1_0C.RData")
outT <- subset(outT, select = -c(sst))
outB <- lapply(outB, function(DF){subset(DF, select = -c(sst))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(sst))})
outL <- lapply(outL, function(DF){subset(DF, select = -c(sst))})
outJ <- lapply(outJ, function(DF){subset(DF, select = -c(sst))})
...
#For synthetic 10
load("Accuracy_matched_sst_10_0C.RData")
outT <- subset(outT, select = -c(sst))
outB <- lapply(outB, function(DF){subset(DF, select = -c(sst))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(sst))})
outL <- lapply(outL, function(DF){subset(DF, select = -c(sst))})
...
#For synthetic 25
load("Accuracy_matched_sst_25_0C.RData")
outT <- subset(outT, select = -c(sst))
outB <- lapply(outB, function(DF){subset(DF, select = -c(sst))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(sst))})
outL <- lapply(outL, function(DF){subset(DF, select = -c(sst))})
...
#For synthetic 50
load("Accuracy_matched_sst_50_0C.RData")
outT <- subset(outT, select = -c(sst))
outB <- lapply(outB, function(DF){subset(DF, select = -c(sst))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(sst))})
outL <- lapply(outL, function(DF){subset(DF, select = -c(sst))})
...
#For synthetic 111
load("Accuracy_matched_sst_111_0C.RData")
outT <- subset(outT, select = -c(sst))
outB <- lapply(outB, function(DF){subset(DF, select = -c(sst))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(sst))})
outL <- lapply(outL, function(DF){subset(DF, select = -c(sst))})
...
outT$WM_sst <- outT$sst #all this because 0 standard deviation
for (i in 1:100){
  outB[[i]]$WM_sst <- outB[[i]]$sst
  outL[[i]]$WM_sst <- outL[[i]]$sst
  outC[[i]]$WM_sst <- outC[[i]]$sst
  outJ[[i]]$WM_sst <- outJ[[i]]$sst
...
save(outT, outB, outL, outC, outJ, file = "Synthetic_all_sst_0C.RData")
