...
#For synthetic 1 
load("Accuracy_matched_lcs_1_0C.RData")
...
#For synthetic 10
load("Accuracy_matched_lcs_10_0C.RData")
outT <- subset(outT, select = -c(ftle))
outB <- lapply(outB, function(DF){subset(DF, select = -c(ftle))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(ftle))})
outL <- lapply(outL, function(DF){subset(DF, select = -c(ftle))})
...
#For synthetic 25
load("Accuracy_matched_lcs_25_0C.RData")
outT <- subset(outT, select = -c(ftle))
outB <- lapply(outB, function(DF){subset(DF, select = -c(ftle))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(ftle))})
outL <- lapply(outL, function(DF){subset(DF, select = -c(ftle))})
...
#For synthetic 50
load("Accuracy_matched_lcs_50_0C.RData")
outT <- subset(outT, select = -c(ftle))
outB <- lapply(outB, function(DF){subset(DF, select = -c(ftle))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(ftle))})
outL <- lapply(outL, function(DF){subset(DF, select = -c(ftle))})
...
#For synthetic 111
load("Accuracy_matched_lcs_111_0C.RData")
outT <- subset(outT, select = -c(ftle))
outB <- lapply(outB, function(DF){subset(DF, select = -c(ftle))})
outC <- lapply(outC, function(DF){subset(DF, select = -c(ftle))})
outL <- lapply(outL, function(DF){subset(DF, select = -c(ftle))})
...
outL$cue <- "ftle"
outJ$cue <- "ftle"
save(outT, outB, outL, outC, outJ, file = "Synthetic_all_LCS_0C.RData")
